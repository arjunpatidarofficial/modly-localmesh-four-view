...
4. Enter full Windows file paths for right, left, back and your LocalMesh `.venv\\Scripts\\python.exe` in the node settings. For now, type/paste paths; some Modly versions open a directory picker for string parameters.
